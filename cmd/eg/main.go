...
func main() {
	...
	parser := kong.Must(
		...
		kong.Vars{
			...
			"vars_runtime_directory":         userx.DefaultRuntimeDirectory(os.Args[0]),
			...
			"vars_memory_minimum_default":  strconv.FormatUint(envx.Uint64(4*bytesx.GiB, "EG_RESOURCES_MEMORY"), 10),
