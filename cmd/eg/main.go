...
func main() {
	...
	parser := kong.Must(
		...
		kong.Vars{
			...
			"vars_memory_minimum_default":  humanize.IBytes(envx.Uint64(4*bytesx.GiB, "EG_RESOURCES_MEMORY")),
			"vars_disk_minimum_default":    humanize.IBytes(envx.Uint64(2*bytesx.GiB, "EG_RESOURCES_DISK")),
