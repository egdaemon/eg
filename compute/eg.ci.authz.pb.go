...
var (
	...
	file_eg_ci_authz_proto_rawDescData []byte
)

func file_eg_ci_authz_proto_rawDescGZIP() []byte {
	file_eg_ci_authz_proto_rawDescOnce.Do(func() {
		file_eg_ci_authz_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_eg_ci_authz_proto_rawDesc), len(file_eg_ci_authz_proto_rawDesc)))
	})
...
func file_eg_ci_authz_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_eg_ci_authz_proto_rawDesc), len(file_eg_ci_authz_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
