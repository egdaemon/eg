// Package duckproxyv2 fronts a single shared in-process DuckDB database
...
// Server serves duckproxyv2's native protocol on behalf of a shared
...
// Serve accepts connections from l and handles duckproxyv2's protocol on
