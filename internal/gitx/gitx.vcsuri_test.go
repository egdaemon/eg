...
func TestVCSURI(t *testing.T) {
	t.Run("expected result", func(t *testing.T) {
		...
		assert.Equal(t, "git@gitlab.com:org/repo.git", vcsuri("ssh://git@gitlab.com:org/repo.git"), "ssh:// gitlab")
		assert.Equal(t, "git@github.com:user/repo.git", vcsuri("ssh://git@github.com:user/repo.git"), "ssh:// normalization")
		...
		assert.Equal(t, "git@github.com:user/repo.git", vcsuri("https://github.com/user/repo.git?param=value"), "query parameters preserved")
