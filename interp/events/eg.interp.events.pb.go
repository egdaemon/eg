...
func (x *Coverage) GetFnName() string {
	if x != nil {
		return x.FnName
	}
	return ""
...
type WorstCoverageFunctionsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *WorstCoverageFunctionsRequest) Reset() {
	*x = WorstCoverageFunctionsRequest{}
	mi := &file_eg_interp_events_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *WorstCoverageFunctionsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorstCoverageFunctionsRequest) ProtoMessage() {}

func (x *WorstCoverageFunctionsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_eg_interp_events_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WorstCoverageFunctionsRequest.ProtoReflect.Descriptor instead.
func (*WorstCoverageFunctionsRequest) Descriptor() ([]byte, []int) {
	return file_eg_interp_events_proto_rawDescGZIP(), []int{18}
}

func (x *WorstCoverageFunctionsRequest) GetN() int32 {
	if x != nil {
		return x.N
	}
	return 0
...
type SampleCoverageFunctionsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	N             int32                  `protobuf:"varint,1,opt,name=n,proto3" json:"n,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *SampleCoverageFunctionsRequest) Reset() {
	*x = SampleCoverageFunctionsRequest{}
	mi := &file_eg_interp_events_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SampleCoverageFunctionsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SampleCoverageFunctionsRequest) ProtoMessage() {}

func (x *SampleCoverageFunctionsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_eg_interp_events_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SampleCoverageFunctionsRequest.ProtoReflect.Descriptor instead.
func (*SampleCoverageFunctionsRequest) Descriptor() ([]byte, []int) {
	return file_eg_interp_events_proto_rawDescGZIP(), []int{19}
}

func (x *SampleCoverageFunctionsRequest) GetN() int32 {
	if x != nil {
		return x.N
	}
	return 0
...
type CoverageFunctionsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Functions     []*Coverage            `protobuf:"bytes,1,rep,name=functions,proto3" json:"functions,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CoverageFunctionsResponse) Reset() {
	*x = CoverageFunctionsResponse{}
	mi := &file_eg_interp_events_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CoverageFunctionsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CoverageFunctionsResponse) ProtoMessage() {}

func (x *CoverageFunctionsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_eg_interp_events_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CoverageFunctionsResponse.ProtoReflect.Descriptor instead.
func (*CoverageFunctionsResponse) Descriptor() ([]byte, []int) {
	return file_eg_interp_events_proto_rawDescGZIP(), []int{20}
}

func (x *CoverageFunctionsResponse) GetFunctions() []*Coverage {
	if x != nil {
		return x.Functions
	}
	return nil
...
func (x *RunUploadChunk_Metadata) Reset() {
	*x = RunUploadChunk_Metadata{}
	mi := &file_eg_interp_events_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_eg_interp_events_proto_rawDesc = "" +
	...
	"fieldsJSONJ\x05\b\x02\x10\xe8\a\"\x87\x01\n" +
	"\bCoverage\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x12\x1e\n" +
	"\n" +
	"statements\x18\x02 \x01(\x02R\n" +
	"statements\x12\x1a\n" +
	"\bbranches\x18\x03 \x01(\x02R\bbranches\x12\x17\n" +
	"\afn_name\x18\x04 \x01(\tR\x06fnName\x12\x12\n" +
	"\x04hits\x18\x05 \x01(\x03R\x04hits\"\xc0\x02\n" +
	"\aMessage\x12\x0e\n" +
	...
	"\x10DispatchResponse\"-\n" +
	"\x1dWorstCoverageFunctionsRequest\x12\f\n" +
	"\x01n\x18\x01 \x01(\x05R\x01n\".\n" +
	"\x1eSampleCoverageFunctionsRequest\x12\f\n" +
	"\x01n\x18\x01 \x01(\x05R\x01n\"U\n" +
	"\x19CoverageFunctionsResponse\x128\n" +
	"\tfunctions\x18\x01 \x03(\v2\x1a.eg.interp.events.CoverageR\tfunctions2\xcb\x02\n" +
	"\x05Agent\x12S\n" +
	...
	"\x05Watch\x12!.eg.interp.events.RunWatchRequest\x1a\x19.eg.interp.events.Message\"\x000\x012\xd3\x02\n" +
	"\x06Events\x12S\n" +
	"\bDispatch\x12!.eg.interp.events.DispatchRequest\x1a\".eg.interp.events.DispatchResponse\"\x00\x12x\n" +
	"\x16WorstCoverageFunctions\x12/.eg.interp.events.WorstCoverageFunctionsRequest\x1a+.eg.interp.events.CoverageFunctionsResponse\"\x00\x12z\n" +
	"\x17SampleCoverageFunctions\x120.eg.interp.events.SampleCoverageFunctionsRequest\x1a+.eg.interp.events.CoverageFunctionsResponse\"\x002]\n" +
	"\x06Runner\x12S\n" +
...
var file_eg_interp_events_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_eg_interp_events_proto_goTypes = []any{
	...
	(*WorstCoverageFunctionsRequest)(nil),  // 19: eg.interp.events.WorstCoverageFunctionsRequest
	(*SampleCoverageFunctionsRequest)(nil), // 20: eg.interp.events.SampleCoverageFunctionsRequest
	(*CoverageFunctionsResponse)(nil),      // 21: eg.interp.events.CoverageFunctionsResponse
	(*RunUploadChunk_Metadata)(nil),        // 22: eg.interp.events.RunUploadChunk.Metadata
}
var file_eg_interp_events_proto_depIdxs = []int32{
	...
	22, // 6: eg.interp.events.RunUploadChunk.metadata:type_name -> eg.interp.events.RunUploadChunk.Metadata
	...
	6,  // 11: eg.interp.events.CoverageFunctionsResponse.functions:type_name -> eg.interp.events.Coverage
	...
	19, // 17: eg.interp.events.Events.WorstCoverageFunctions:input_type -> eg.interp.events.WorstCoverageFunctionsRequest
	20, // 18: eg.interp.events.Events.SampleCoverageFunctions:input_type -> eg.interp.events.SampleCoverageFunctionsRequest
	17, // 19: eg.interp.events.Runner.Dispatch:input_type -> eg.interp.events.DispatchRequest
	9,  // 20: eg.interp.events.Agent.Upload:output_type -> eg.interp.events.RunUploadResponse
	15, // 21: eg.interp.events.Agent.Cancel:output_type -> eg.interp.events.RunCancelResponse
	11, // 22: eg.interp.events.Agent.Logs:output_type -> eg.interp.events.RunLogResponse
	7,  // 23: eg.interp.events.Agent.Watch:output_type -> eg.interp.events.Message
	18, // 24: eg.interp.events.Events.Dispatch:output_type -> eg.interp.events.DispatchResponse
	21, // 25: eg.interp.events.Events.WorstCoverageFunctions:output_type -> eg.interp.events.CoverageFunctionsResponse
	21, // 26: eg.interp.events.Events.SampleCoverageFunctions:output_type -> eg.interp.events.CoverageFunctionsResponse
	18, // 27: eg.interp.events.Runner.Dispatch:output_type -> eg.interp.events.DispatchResponse
