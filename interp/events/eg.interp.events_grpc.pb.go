...
type AgentClient interface {
	...
	Initiate(ctx context.Context, in *RunInitiateRequest, opts ...grpc.CallOption) (*RunInitiateResult, error)
...
func (c *agentClient) Initiate(ctx context.Context, in *RunInitiateRequest, opts ...grpc.CallOption) (*RunInitiateResult, error) {
	out := new(RunInitiateResult)
	err := c.cc.Invoke(ctx, "/eg.interp.events.Agent/Initiate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AgentServer interface {
	...
	Initiate(context.Context, *RunInitiateRequest) (*RunInitiateResult, error)
...
func (UnimplementedAgentServer) Initiate(context.Context, *RunInitiateRequest) (*RunInitiateResult, error) {
...
func _Agent_Initiate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RunInitiateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentServer).Initiate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/eg.interp.events.Agent/Initiate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServer).Initiate(ctx, req.(*RunInitiateRequest))
	}
...
var Agent_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Initiate",
			Handler:    _Agent_Initiate_Handler,
		},
		{
			MethodName: "Cancel",
