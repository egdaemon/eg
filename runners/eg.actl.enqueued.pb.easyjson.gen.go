...
func easyjson61363d27DecodeGithubComEgdaemonEgRunners8(in *jlexer.Lexer, out *Enqueued) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson61363d27EncodeGithubComEgdaemonEgRunners8(out *jwriter.Writer, in Enqueued) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Id != "" {
